        ...
        <div class="table-responsive">
          <table class="table ps-table--compare">
            <tbody>
              <tr>
                <td>Product</td>
                <td><a class="ps-product--table" href="product-detail.html"><img src="images/products/1.png" alt=""> Bread</a></td>
                <td><a class="ps-product--table" href="product-detail.html"><img src="images/products/2.png" alt=""> Bread 2</a></td>
              </tr>
              <tr>
                <td>Pricing</td>
              ...
              <tr>
                <td>Order</td>
                <td><a class="ps-btn ps-btn--yellow" href="#">Add to cart</a><a class="ps-btn--favorite ml-10" href="whishlist.html"><i class="ba-heart"></i></a></td>
                <td><a class="ps-btn ps-btn--yellow" href="#">Add to cart</a><a class="ps-btn--favorite ml-10" href="whishlist.html"><i class="ba-heart"></i></a></td>
              </tr>
            </tbody>
          </table>
