        ...
        <div class="table-responsive">
          <table class="table ps-table ps-table--whishlist">
            ...
            <tbody>
              ...
              <tr>
                <td><a class="ps-product--table" href="product-detail.html"><img class="mr-15" src="images/products/2.png" alt=""> The Crusty Croissant</a></td>
                <td><strong>$150</strong></td>
                <td><a class="ps-product-link" href="product-detail.html">View Product</a></td>
                <td>
                  <div class="ps-remove"></div>
              ...
              <tr>
                <td><a class="ps-product--table" href="product-detail.html"><img class="mr-15" src="images/products/3.png" alt="">The Rolling Pin</a></td>
                <td><strong>$150</strong></td>
                <td><a class="ps-product-link" href="product-detail.html">View Product</a></td>
                <td>
                  <div class="ps-remove"></div>
